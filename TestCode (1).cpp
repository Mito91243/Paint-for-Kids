...
int main()
{
	...
	do
	{
		...
		case COLORFILL:
			pOut->PrintMessage("Action: To fill the shape, click anywhere");
			break;

		case DRAWCOLOR:
			pOut->PrintMessage("Action: To color the draw, click anywhere");
			break;

		case BLACK:
			pOut->PrintMessage("Action: For black color, click anywhere");
			break;

		case YELLOW:
			pOut->PrintMessage("Action: For yellow color, click anywhere");
			break;

		case ORANGE:
			pOut->PrintMessage("Action: For orange color, click anywhere");
			break;

		case RED:
			pOut->PrintMessage("Action: For red color, click anywhere");
			break;

		case GREEN:
			pOut->PrintMessage("Action: For green color, click anywhere");
			break;

		case BLUE:
			pOut->PrintMessage("Action: For blue color, click anywhere");
			break;

		case MOVE:
			pOut->PrintMessage("Action: To move the shape, click anywhere");
			break;

		case TO_DELETE:
			pOut->PrintMessage("Action: To delete the shape, click anywhere");
			break;

		case UNDO:
			pOut->PrintMessage("Action: To undo, click anywhere");
			break;

		case REDO:
			pOut->PrintMessage("Action: To redo, click anywhere");
			break;

		case CLEARALL:
			pOut->PrintMessage("Action: To clear all, click anywhere");
			break;

		case STARTRECORDING:
			pOut->PrintMessage("Action: To start the recording, click anywhere");
			break;

		case PAUSERECORDING:
			pOut->PrintMessage("Action: To pause the recording, click anywhere");
			break;

		case STOPRECORDING:
			pOut->PrintMessage("Action: To stop the recording, click anywhere");
			break;

		case SAVEGRAPH:
			pOut->PrintMessage("Action: To save your graphs, click anywhere");
			break;
		
		case LOADGRAPH:
			pOut->PrintMessage("Action: To load your graphs, click anywhere");
			break;

		case ADDVOICE:
			pOut->PrintMessage("Action: To add voice, click anywhere");
			break;
